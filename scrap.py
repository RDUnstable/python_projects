#THIS IS A SPECIAL TYPE OF CODE THAT TAKES AN URL AND COLLECTS ALL THE LINKS FROM THAT PAGE USING THE BeautifulSoup MODULE IN PYTHON
#AT FIRST IT TAKES THE URL AS INPUT FROM YOU
#THEN IT COLLECTS ALL THE LINKS
#AT THE NEXT STEP IT ASKS YOU TO ENTER ANY WORD AND GIVES YOU ALL THE LINKS RELATED WITH THE WORD...
#BUT YOU CANNOT OPEN ANY RANDOM LINK HERE :P
